# Form implementation generated from reading ui file 'uyebilgisayargiris.ui'
#
...
"")
        ...
        self.username_input_UYEbb = QtWidgets.QLineEdit(parent=self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.username_input_UYEbb.sizePolicy().hasHeightForWidth())
        self.username_input_UYEbb.setSizePolicy(sizePolicy)
        self.username_input_UYEbb.setText("")
        self.username_input_UYEbb.setObjectName("username_input_UYEbb")
        self.verticalLayout_3.addWidget(self.username_input_UYEbb)
...
"font: 9pt \"Snap ITC\";")
        ...
        self.password_input_UYEbb = QtWidgets.QLineEdit(parent=self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.password_input_UYEbb.sizePolicy().hasHeightForWidth())
        self.password_input_UYEbb.setSizePolicy(sizePolicy)
        self.password_input_UYEbb.setEchoMode(QtWidgets.QLineEdit.EchoMode.Password)
        self.password_input_UYEbb.setObjectName("password_input_UYEbb")
        self.verticalLayout_3.addWidget(self.password_input_UYEbb)
        self.checkBox_UYEbb = QtWidgets.QCheckBox(parent=self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.checkBox_UYEbb.sizePolicy().hasHeightForWidth())
        self.checkBox_UYEbb.setSizePolicy(sizePolicy)
        self.checkBox_UYEbb.setStyleSheet("font: 9pt \"Snap ITC\";\n"
"color: rgb(255, 255, 255);")
        self.checkBox_UYEbb.setObjectName("checkBox_UYEbb")
        self.verticalLayout_3.addWidget(self.checkBox_UYEbb)
        self.pushButtonbb = QtWidgets.QPushButton(parent=self.widget_3)
        self.pushButtonbb.setStyleSheet("font: 9pt \"Snap ITC\";")
        self.pushButtonbb.setObjectName("pushButtonbb")
        self.verticalLayout_3.addWidget(self.pushButtonbb)
        self.login_button_UYEbb = QtWidgets.QPushButton(parent=self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.login_button_UYEbb.sizePolicy().hasHeightForWidth())
        self.login_button_UYEbb.setSizePolicy(sizePolicy)
        self.login_button_UYEbb.setStyleSheet("font: 9pt \"Snap ITC\";\n"
"color: rgb(255, 255, 255);")
        self.login_button_UYEbb.setObjectName("login_button_UYEbb")
        self.verticalLayout_3.addWidget(self.login_button_UYEbb)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_4.setText(_translate("Form", "BİLGİSAYAR BİRİMİ ÜYE GİRİŞİNE HOŞ GELDİNİZ"))
        self.label_5.setText(_translate("Form", "   KULLANICI ADI :"))
        self.label_6.setText(_translate("Form", "   ŞİFRE :"))
        self.checkBox_UYEbb.setText(_translate("Form", " Şifre Göster"))
        self.pushButtonbb.setText(_translate("Form", "ŞİFREMİ UNUTTUM"))
        self.login_button_UYEbb.setText(_translate("Form", "GİRİŞ"))
