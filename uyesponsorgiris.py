# Form implementation generated from reading ui file 'uyesponsorgiris.ui'
#
...
"")
        ...
        self.username_input_UYEss = QtWidgets.QLineEdit(parent=self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.username_input_UYEss.sizePolicy().hasHeightForWidth())
        self.username_input_UYEss.setSizePolicy(sizePolicy)
        self.username_input_UYEss.setText("")
        self.username_input_UYEss.setObjectName("username_input_UYEss")
        self.verticalLayout_3.addWidget(self.username_input_UYEss)
...
"font: 9pt \"Snap ITC\";")
        ...
        self.password_input_UYEss = QtWidgets.QLineEdit(parent=self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.password_input_UYEss.sizePolicy().hasHeightForWidth())
        self.password_input_UYEss.setSizePolicy(sizePolicy)
        self.password_input_UYEss.setEchoMode(QtWidgets.QLineEdit.EchoMode.Password)
        self.password_input_UYEss.setObjectName("password_input_UYEss")
        self.verticalLayout_3.addWidget(self.password_input_UYEss)
        self.checkBox_UYEss = QtWidgets.QCheckBox(parent=self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.checkBox_UYEss.sizePolicy().hasHeightForWidth())
        self.checkBox_UYEss.setSizePolicy(sizePolicy)
        self.checkBox_UYEss.setStyleSheet("font: 9pt \"Snap ITC\";\n"
"color: rgb(255, 255, 255);")
        self.checkBox_UYEss.setObjectName("checkBox_UYEss")
        self.verticalLayout_3.addWidget(self.checkBox_UYEss)
        self.pushButtonss = QtWidgets.QPushButton(parent=self.widget_3)
        self.pushButtonss.setStyleSheet("font: 9pt \"Snap ITC\";")
        self.pushButtonss.setObjectName("pushButtonss")
        self.verticalLayout_3.addWidget(self.pushButtonss)
        self.login_button_UYEss = QtWidgets.QPushButton(parent=self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.login_button_UYEss.sizePolicy().hasHeightForWidth())
        self.login_button_UYEss.setSizePolicy(sizePolicy)
        self.login_button_UYEss.setStyleSheet("font: 9pt \"Snap ITC\";\n"
"color: rgb(255, 255, 255);")
        self.login_button_UYEss.setObjectName("login_button_UYEss")
        self.verticalLayout_3.addWidget(self.login_button_UYEss)
    ...
    def retranslateUi(self, Form):
        ...
        self.checkBox_UYEss.setText(_translate("Form", " Şifre Göster"))
        self.pushButtonss.setText(_translate("Form", "ŞİFREMİ UNUTTUM"))
        self.login_button_UYEss.setText(_translate("Form", "GİRİŞ"))
        self.label_4.setText(_translate("Form", "SPONSOR BİRİMİ ÜYE GİRİŞİNE HOŞ GELDİNİZ"))
