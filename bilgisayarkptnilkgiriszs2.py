# Form implementation generated from reading ui file 'bilgisayarkptnilkgiriszs2.ui'
#
...
"")
        ...
        self.username_input_2 = QtWidgets.QLineEdit(parent=self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.username_input_2.sizePolicy().hasHeightForWidth())
        self.username_input_2.setSizePolicy(sizePolicy)
        self.username_input_2.setText("")
        self.username_input_2.setObjectName("username_input_2")
        self.verticalLayout_3.addWidget(self.username_input_2)
...
"font: 9pt \"Snap ITC\";")
        ...
        self.password_input_2 = QtWidgets.QLineEdit(parent=self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.password_input_2.sizePolicy().hasHeightForWidth())
        self.password_input_2.setSizePolicy(sizePolicy)
        ...
        self.verticalLayout_3.addWidget(self.password_input_2)
        ...
        self.checkBox_3.setStyleSheet("font: 9pt \"Snap ITC\";\n"
"color: rgb(255, 255, 255);")
        self.checkBox_3.setObjectName("checkBox_3")
        self.verticalLayout_3.addWidget(self.checkBox_3)
        self.pushButtonkaptansponsor = QtWidgets.QPushButton(parent=self.widget_3)
        self.pushButtonkaptansponsor.setStyleSheet("font: 9pt \"Snap ITC\";")
        self.pushButtonkaptansponsor.setObjectName("pushButtonkaptansponsor")
        self.verticalLayout_3.addWidget(self.pushButtonkaptansponsor)
        self.login_button_2 = QtWidgets.QPushButton(parent=self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.login_button_2.sizePolicy().hasHeightForWidth())
        self.login_button_2.setSizePolicy(sizePolicy)
        self.login_button_2.setStyleSheet("font: 9pt \"Snap ITC\";\n"
"color: rgb(255, 255, 255);")
        self.login_button_2.setObjectName("login_button_2")
        self.verticalLayout_3.addWidget(self.login_button_2)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_4.setText(_translate("Form", "TAKIM KAPTANI GİRİŞİNE HOŞ GELDİNİZ"))
        self.label_5.setText(_translate("Form", "   KULLANICI ADI :"))
        self.label_6.setText(_translate("Form", "   ŞİFRE :"))
        self.checkBox_3.setText(_translate("Form", " Şifre Göster"))
        self.pushButtonkaptansponsor.setText(_translate("Form", "ŞİFREMİ UNUTTUM"))
        self.login_button_2.setText(_translate("Form", "GİRİŞ"))
