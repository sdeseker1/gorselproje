# Form implementation generated from reading ui file 'uyeelektirikgiris.ui'
#
...
"")
        ...
        self.username_input_UYEee = QtWidgets.QLineEdit(parent=self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.username_input_UYEee.sizePolicy().hasHeightForWidth())
        self.username_input_UYEee.setSizePolicy(sizePolicy)
        self.username_input_UYEee.setText("")
        self.username_input_UYEee.setObjectName("username_input_UYEee")
        self.verticalLayout_3.addWidget(self.username_input_UYEee)
...
"font: 9pt \"Snap ITC\";")
        ...
        self.password_input_UYEee = QtWidgets.QLineEdit(parent=self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.password_input_UYEee.sizePolicy().hasHeightForWidth())
        self.password_input_UYEee.setSizePolicy(sizePolicy)
        self.password_input_UYEee.setEchoMode(QtWidgets.QLineEdit.EchoMode.Password)
        self.password_input_UYEee.setObjectName("password_input_UYEee")
        self.verticalLayout_3.addWidget(self.password_input_UYEee)
        self.checkBox_UYEee = QtWidgets.QCheckBox(parent=self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.checkBox_UYEee.sizePolicy().hasHeightForWidth())
        self.checkBox_UYEee.setSizePolicy(sizePolicy)
        self.checkBox_UYEee.setStyleSheet("font: 9pt \"Snap ITC\";\n"
"color: rgb(255, 255, 255);")
        self.checkBox_UYEee.setObjectName("checkBox_UYEee")
        self.verticalLayout_3.addWidget(self.checkBox_UYEee)
        self.pushButtonee = QtWidgets.QPushButton(parent=self.widget_3)
        self.pushButtonee.setStyleSheet("font: 9pt \"Snap ITC\";")
        self.pushButtonee.setObjectName("pushButtonee")
        self.verticalLayout_3.addWidget(self.pushButtonee)
        self.login_button_UYEee = QtWidgets.QPushButton(parent=self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.login_button_UYEee.sizePolicy().hasHeightForWidth())
        self.login_button_UYEee.setSizePolicy(sizePolicy)
        self.login_button_UYEee.setStyleSheet("font: 9pt \"Snap ITC\";\n"
"color: rgb(255, 255, 255);")
        self.login_button_UYEee.setObjectName("login_button_UYEee")
        self.verticalLayout_3.addWidget(self.login_button_UYEee)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_4.setText(_translate("Form", "ELEKTİRİK BİRİMİ ÜYE GİRİŞİNE HOŞ GELDİNİZ"))
        self.label_5.setText(_translate("Form", "   KULLANICI ADI :"))
        self.label_6.setText(_translate("Form", "   ŞİFRE :"))
        self.checkBox_UYEee.setText(_translate("Form", " Şifre Göster"))
        self.pushButtonee.setText(_translate("Form", "ŞİFREMİ UNUTTUM"))
        self.login_button_UYEee.setText(_translate("Form", "GİRİŞ"))
